...
public class ToolsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<Item> options = new FirebaseRecyclerOptions.Builder<Item>()
                .setQuery(FirebaseDatabase.getInstance().getReference("ItemList")
                        .orderByChild("itemType").equalTo("tool"), Item.class)
                .build();

        adapter = new PublicItemAdapter(options);
        RecyclerView recyclerView = findViewById(R.id.tool_recycler_public_itemView);
            ...
            ref.orderByChild(item.getUID()).addChildEventListener(new ChildEventListener() {
                ...
                public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                    if(snapshot.getKey().equals(item.getUID())){
                        ...
                        dialog.show();
                      //  Toast.makeText(ToolsActivity.this, "Seller Successful" , Toast.LENGTH_LONG).show();
                    }
                }
        ...
        Dialog dialog1=new Dialog(ToolsActivity.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(ToolsActivity.this,MainActivity_NavigationPage.class));
    }
