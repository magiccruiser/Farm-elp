...
public class SowingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = findViewById(R.id.sowing_recycler_public_itemView);
        ...
        Dialog dialog=new Dialog(SowingActivity.this);
        ...
        Dialog dialog1=new Dialog(SowingActivity.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(SowingActivity.this,MainActivity_NavigationPage.class));
    }
